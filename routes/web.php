...
//============================================================//
    ...
    Route::get('order/detail/{id}', ['as' => 'order.list.detail', 'uses' => 'Admin\\ProductController@orderListDetail']);
     ...
     //Order Status Change Routes//
       ...
       Route::get('status/active/{id}','Admin\\ProductController@updatestatusactive')->name('status.active');
    Route::get('status/expired/{id}','Admin\\ProductController@updatestatusExpired')->name('status.expired');
...
Route::resource('admin/timesheet', 'Admin\\TimesheetController');
Route::resource('admin/blanksheet', 'Admin\\BlanksheetController');
