...
class BannerController extends Controller
{
    ...
    $file = $request->file('banner_image');
            ...
            //make sure yo have image folder inside your public
            $destination_path = 'uploads/bannerimage/';
            $profileImage = date("Y-m-d").".".$file->getClientOriginalExtension();
            // dd($destination_path,$profileImage);
            // $file->move(public_path($destination_path), $profileImage);
            ...
            //save the link of thumbnail into myslq database        
            $banner->banner_image = $destination_path.$profileImage;
   ...
   if ($request->hasFile('banner_image')) {
            ...
            $fileNameToStore = $fileName.'_'.time().'.'.$fileExt;
            $pathToStore = public_path('uploads/bannerimage/');
            Image::make($file)->save($pathToStore . DIRECTORY_SEPARATOR. $fileNameToStore);
            $requestData['banner_image'] = 'uploads/bannerimage/'.$fileNameToStore;        
