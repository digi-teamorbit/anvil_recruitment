...
</div><div class="form-group row justify-content-center left_css col-md-12 {{ $errors->has('job_id') ? 'has-error' : ''}}">
    {!! Form::label('job_id', 'Job Id', ['class' => 'col-md-12 control-label']) !!}
    <div class="col-md-12">
