...
<div class="form-group row justify-content-center  {{ $errors->has('banner_image') ? 'has-error' : ''}}">
    {!! Form::label('banner_image', 'Banner Image', ['class' => 'col-md-12 control-label']) !!}
    <div class="col-md-12">

      <div class="max-text">
        <img alt="" class="img-responsive" id="banner1" 
        src="{{ isset($banner)?asset($banner->banner_image):asset('images/upload.jpg') }}" style=" width: 30%; "> 
        <br/>
      </div>
        <br/>
        {!! Form::file('banner_image', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
